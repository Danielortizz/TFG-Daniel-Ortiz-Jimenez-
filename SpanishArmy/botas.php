...
//recorre la consulta y los muestra
	...
	<div class="card" id="carta-catalogog" style="width: 18rem;">
		  		<img class="imagen-catalogo2" src="<?php echo $mostrar['Imagen'] ?>" class="card-img-top">
		  			<div class="card-body">
			    		<h5 class="card-title" id="titulo"><b><?php echo $mostrar['Nombre'] ?></h5></b><br>
					   		<p class="card-text" align="center">Precio: <b> <?php echo $mostrar['Precio'] ?> </b></p>
					   		<p class="card-text" id="titulo2" align="center">Talla: <b><br><?php echo $mostrar['Talla'] ?> </b></p>
					   		<p class="card-text" id="titulo2" align="center">Descripcion: <b><br><?php echo $mostrar['Descripcion'] ?> </b></p>
		 	 		</div>
