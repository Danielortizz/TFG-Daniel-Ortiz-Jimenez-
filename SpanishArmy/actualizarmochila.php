...
//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñarmochilaporid($conexion,$idmochilas);
...
<div class="card" id="card-login" style="width: 30rem; height: 40%;">
		<div>
		<center>
			<form action="modificarmochilas.php" method="POST" enctype="multipart/form-data" style="color: white">
				...
				<input type="hidden"  name="idmochilas" value="<?php echo $idmochilas ?>">
			</form>
		</center>
		</div>
</div>
