	...
	<div class="card" id="carta-catalogog" style="width: 18rem;">
		  		<img id="ñao" class="imagenes" src="<?php echo $mostrar['Imagen'] ?>">
		  			<div class="card-body" style="padding: 0rem 0rem">
			    		<h5 class="card-title" id="titulocarta"><b><?php echo $mostrar['Titulo'] ?></h5></b>
					   		<p class="card-text" id="titulo2" align="center" id="descripcioncarta"><b><?php echo $mostrar['Descripcion'] ?> </b>
					   		</p>

					   		<p align="center" ><a href="<?php echo $mostrar['Video']; ?>" class="btn btn-light" value="Comprar" name="Comprar" ><b>VER VIDEO</b></a></p>

					   		<p class="card-text" align="center" id="preciocarta"><b> <?php echo $mostrar['Publicacion'] ?> </b></p>
		 	 		</div>
