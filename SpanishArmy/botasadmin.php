...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td id="td"><b> <?php echo $fila['idbotas'] ?> </b></td>
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="borrarbotas.php?idbotas=<?php  echo $fila['idbotas'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta botas?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a class="nav-link active" aria-current="page" href="actualizarbotas.php?idbotas=<?php echo $fila['idbotas']; ?>" value="Modificar" name="Modificar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
