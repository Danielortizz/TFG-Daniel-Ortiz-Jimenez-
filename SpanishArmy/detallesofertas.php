...
//usamos una funcion que nos permite mostrar las consolas de la base de datos
	$result = enseñarofertaporid($conexion,$idoferta);
...
//recorre la consulta y los muestra
	...
	<div class="comentarios">
		...
		<textarea name="coments" id="coments" style="width: 100%;">
			...
			<button class="botoncoments" name="coments" id="coments" data-Producto="<?php echo $idoferta; ?>" data-idUsuario="<?php echo $idUsuario; ?> " style="width: 100%;">Enviar</button>
	</div>
