 ...
 <div class="cuerpo">
	...
	<table class="table table-striped table-dark">
		...
		<tr style="margin-top: 2%;">
			...
			<td><b> <?php echo $_SESSION['Dni']?> </b></td>
			
			<td>
				<ul class="nav justify-content-center">
			  		<li class="nav-item" id="botones">
			    		<a class="nav-link active" aria-current="page" href="actualizarrusuario.php?idUsuario=<?php echo $_SESSION['idUsuario']; ?>" value="Actualizar" name="Actualizar">
