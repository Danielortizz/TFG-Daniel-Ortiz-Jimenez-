	...
	<div class="card" id="carta-catalogog" style="width: 18rem;">
		  		<img src="<?php echo $mostrar['Imagen'] ?>" id="ñao" class="imagenes">
		  			<div class="card-body" style="padding: 0rem 0rem;">
			    		...
			    		<p align="center" ><a style="color: white; align-content: center;" class="btn btn-dark" href="detallescamisetas.php?idcamisetas=<?php echo $mostrar['idcamisetas']; ?>" value="Comprar" name="Comprar">COMPRAR</a></p>
