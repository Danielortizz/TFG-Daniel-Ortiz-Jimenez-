...
<body background="img/fondo2.jpg">
 ...
 <div><img src="img/header.png" class="imagen-header" width="1300" height="250"></div>
	...
	<ul class="nav justify-content-center" id="barra">
		...
		<ul class="nav justify-content-end" id="barra">
		    <li class="nav-item">
		    <a class="nav-link active" aria-current="page" href="añadirusuario.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus" viewBox="0 0 16 16">
...
<center>
	...
	<td>
		<ul class="nav justify-content-center">
			...
			<a class="nav-link active" aria-current="page" href="actualizarusuario.php?idUsuario=<?php echo $fila['idUsuario']; ?>" value="Actualizar" name="Actualizar" onclick="return confirm('Estás seguro que vas a modificar este usuario?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
		...
		<button ><a href="borrarusuario.php?idUsuario=<?php  echo $fila['idUsuario'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que deseas eliminar el usuario?');"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
