...
//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñarcamisetaporid($conexion,$idcamisetas);
...
<div class="cuerpo">	
	...
	<div id="card-html" style="width: 27rem; margin-top: 9%;">
		...
		<center>
			<form action="modificarcamisetas.php" method="POST" enctype="multipart/form-data" style="text-align: center;">
				...
				<input type="hidden"  name="idcamisetas" value="<?php echo $idcamisetas ?>">
			</form>
		</center>
