...
<body background="img/fondo2.jpg">
 ...
 <div class="cuerpo">
	...
	<center>
	<div id="card-html" style="width: 27rem; margin-top: 9%; margin-bottom: 9%;" >
	<div> 

		<form action="nuevadieta.php" method="POST" enctype="multipart/form-data" id="cartaa">
			
			<b>Tipo de dieta: </b><input type="text" name="tipodedieta" id="tipodedieta" class="form-control" placeholder=""><br>
			
			<b>Ingredientes: </b><input type="text" name="ingredientes" id="ingredientes" class="form-control" placeholder=""><br>

			<b>Entrenamiento: </b><input type="text" name="entrenamiento" id="entrenamiento" class="scroll" placeholder=""><br><br>

			<b>Recuperacion post ejercicio: </b><input type="text" name="recuperacion" id="recuperacion" class="scroll" placeholder=""><br><br>
