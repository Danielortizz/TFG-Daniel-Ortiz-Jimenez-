...
//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñarofertaporid($conexion,$idoferta);
...
<div class="cuerpo">	
	...
	<div id="card-html" style="width: 30rem; height: 40%; margin-top: 9%;">
		
		<div>
		<center>
			<form action="modificarofertas.php" method="POST" enctype="multipart/form-data" style="text-align: center">
				
				<b>Nombre: </b><input type="text" name="nombre" id="nombre" class="form-control" placeholder="" value="<?php echo $fila['Nombre']; ?>"><br>
				

				<b>Precio: </b><input type="text" name="precio" id="precio" class="form-control" placeholder="" value="<?php echo $fila['Precio']; ?>"><br><br>
