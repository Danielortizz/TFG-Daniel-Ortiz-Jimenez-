...
//usamos una funcion que nos permite mostrar las consolas de la base de datos
	$result = enseñarmochilaporid($conexion,$idmochilas);
...
//recorre la consulta y los muestra
	...
	?>
		...
		<div class="card" id="carta-detalles" style="width: 25rem;">
				<img class="imagen-detalles" src="<?php echo $mostrar['Imagen'] ?>" class="card-img-top" id="ñao">
		  			<div class="card-body" align="center">
			    		<h5 class="card-title" align="center" id="titulocarta"><b> <?php echo $mostrar['Nombre'] ?> </b></h5>
					   		...
					   		<p align="center" ><a style="color: black; align-content: center;" class="btn btn-light" href="insertarMochilacarrito.php?idmochilas=<?php echo $mostrar['idmochilas']; ?>" value="Comprar" name="Comprar"><b>AÑADIR AL CARRITO</b></a></p>
	...
	<div class="comentarios">
		...
		<textarea name="coments" id="coments" style="width: 100%;">
			...
			<button class="botoncoments" name="coments" id="coments" data-Producto="<?php echo $idmochilas; ?>" data-idUsuario="<?php echo $idUsuario; ?> " style="width: 100%;">Enviar</button>
	</div>
