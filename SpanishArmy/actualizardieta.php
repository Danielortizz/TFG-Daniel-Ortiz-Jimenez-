...
//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñardietaporid($conexion,$iddieta);
...
<div class="card" id="card-login" style="width: 30rem; height: 30%; margin-bottom: 9%;">

	<div>
	<center>
		<form action="modificardieta.php" method="POST" enctype="multipart/form-data" style="color: white">

			<b>Ingredientes: </b><input type="text" name="ingredientes" id="titulo" class="form-control" placeholder="" value="<?php echo $fila['Ingredientes']; ?>"><br>
			
			<b>Tipo de dieta: </b><input type="text" name="tipodedieta" id="titulo" class="form-control" placeholder="" value="<?php echo $fila['Tipo de dieta']; ?>"><br>

			<b>Entrenamiento: </b><input type="text" name="entrenamiento" id="compañia" class="scroll" placeholder="" value="<?php echo $fila['Entrenamiento']; ?>"><br><br>

			<b>Recuperacion post ejercicio: </b><input type="text" name="recuperacion" class="scroll" value="<?php echo $fila['Recuperacion post ejercicio'] ?>"><br><br>
