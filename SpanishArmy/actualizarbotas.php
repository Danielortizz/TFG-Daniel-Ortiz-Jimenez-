...
//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñarbotaporid($conexion,$idbotas);
...
<div class="cuerpo">	
	...
	<div class="card" id="card-login" style="width: 30rem; height: 40%;">
		...
		<center>
			<form action="modificarbotas.php" method="POST" enctype="multipart/form-data" style="color: white">
				...
				<input type="hidden"  name="idbotas" value="<?php echo $idbotas ?>">
			</form>
		</center>
		</div>
	</div>
