	...
	<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="añadirnoticia.php?idnoticias=<?php  echo $fila['idnoticias'];?>" value="añadir" name="añadir"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
...
//usamos una funcion que nos permite mostrar las noticias de la base de datos
...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td id="td"><b> <?php echo $fila['idnoticias'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Titulo'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Publicacion'] ?> </b></td>
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="borrarnoticia.php?idnoticias=<?php  echo $fila['idnoticias'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta noticia?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a class="nav-link active" aria-current="page" href="actualizarnoticias.php?idnoticias=<?php echo $fila['idnoticias']; ?>" value="Modificar" name="Modificar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
