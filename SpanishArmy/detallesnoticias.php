...
//usamos una funcion que nos permite mostrar las noticias de la base de datos
	$result = enseñarnoticiaporid($conexion,$idnoticias);
...
//recorre la consulta y los muestra
	...
	?>
		...
		<div class="card" id="carta-detalles" style="width: 30rem; margin-bottom: 30px;">
				<img id="ñao" style="width: 478px; height: 240px;" src="<?php echo $mostrar['Imagen'] ?>" class="card-img-top">
		  			<div class="card-body" text-align="center" style="padding: 0rem 0rem">
			    		<h5 class="card-title" text-align="center" id="titulocarta"><b> <?php echo $mostrar['Titulo'] ?> </b></h5>
			    			<p class="card-text" text-align="center" id="descripcioncarta" style="color: black; background: white;"><b> <?php echo $mostrar['Publicacion'] ?> </b></p>
					   		<p class="card-text" text-align="center" id="descripcioncarta" ><b> <?php echo $mostrar['Descripcion'] ?> </b></p>
					   		<iframe width="460" height="300" src="<?php echo $mostrar['Video'] ?>" allowfullscreen></iframe>	
		 	 		</div>
