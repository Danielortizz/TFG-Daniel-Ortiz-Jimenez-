...
//Y cogemos el id de pantalon por que lo vamos a necesitar
	$idpantalones = $_GET['idpantalones'];

//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñarpantalonporid($conexion,$idpantalones);
...
<div class="card" id="card-login" style="width: 27rem; height: 40%; margin-top: 9%;">

	<div>
	<center>
		<form action="modificarpantalon.php" method="POST" enctype="multipart/form-data" style="color: white; text-align: center;">
			
			<b>Nombre: </b><input type="text" name="nombre" id="nombre" class="form-control" placeholder="" value="<?php echo $fila['Nombre']; ?>"><br>
			

			<b>Precio: </b><input type="text" name="precio" id="precio" class="form-control" placeholder="" value="<?php echo $fila['Precio']; ?>"><br>

			<b>Descripcion: </b><input type="text" name="descripcion" class="scroll" value="<?php echo $fila['Descripcion'] ?>"><br><br>
			...
			<input type="hidden"  name="idpantalones" value="<?php echo $idpantalones ?>">
		</form>
	</center>
	</div>
</div>
