...
//usamos una funcion que nos permite mostrar las consolas de la base de datos
	$result = enseñarpantalonporid($conexion,$idpantalones);
...
//recorre la consulta y los muestra
	...
	?>
		...
		<div class="card" id="carta-detalles" style="width: 25rem;">
				<img src="<?php echo $mostrar['Imagen'] ?>" class="card-img-top" id="ñao">
		  			<div class="card-body" align="center">
			    		<h5 class="card-title" align="center" id="titulocarta"><b> <?php echo $mostrar['Nombre'] ?> </b></h5>
					   		...
					   		<p align="center" ><a style="color: black; align-content: center;" class="btn btn-light" href="insertarPantaloncarrito.php?idpantalones=<?php echo $mostrar['idpantalones']; ?>" value="Comprar" name="Comprar"><b>AÑADIR AL CARRITO</b></a></p>
