...
//recorre la consulta y los muestra
	...
	<div class="card" id="carta-catalogog" style="width: 18rem;">
		  		<img class="imagen-catalogo2" src="<?php echo $mostrar['Imagen'] ?>" class="card-img-top">
		  			<div class="card-body">
			    		<h5 class="card-title" id="titulo2"><b><?php echo $mostrar['Nombre'] ?></h5></b><br>
					   		<p class="card-text" align="center">Precio: <b><br> <?php echo $mostrar['Precio'] ?> </b></p>
					   		<p class="card-text" id="titulo" align="center">Talla: <b><br><?php echo $mostrar['Talla'] ?> </b></p>
					   		<p class="card-text" align="center"><b> <?php echo $mostrar['Descripcion'] ?> </b></p>
		 	 		</div>
