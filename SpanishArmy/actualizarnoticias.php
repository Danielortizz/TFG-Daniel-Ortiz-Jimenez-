...
//la funcion la paso a una consulta y despues obtenemos los valores	
	$consulta = enseñarnoticiaporid($conexion,$idnoticias);
...
<div class="cuerpo">	
	...
	<div class="card" id="card-login" style="width: 30rem; height: 40%;">
		...
		<div>
		<center>
			<form action="modificarnoticia.php" method="POST" enctype="multipart/form-data" style="color: white;">
				
				<b>Nombre: </b><input type="text" name="titulo" id="titulo" class="form-control" placeholder="" value="<?php echo $fila['Titulo']; ?>"><br>
				

				<b>Precio: </b><input type="text" name="publicacion" id="publicacion" class="form-control" placeholder="" value="<?php echo $fila['Publicacion']; ?>"><br>
