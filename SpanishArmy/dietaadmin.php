...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="borrardieta.php?iddieta=<?php  echo $fila['iddieta'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta dieta?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
