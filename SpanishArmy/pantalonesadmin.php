 ...
 <div><img src="img/header.png" class="imagen-header" width="1300" height="250"></div>
	...
	<ul class="nav justify-content-center" id="barra">
	    ...
	    <ul class="nav justify-content-end" id="barra">
			...
			<ul class="nav justify-content-end" id="barra">
			    <li class="nav-item">
			    <a class="nav-link active" aria-current="page" href="añadirpantalon.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus" viewBox="0 0 16 16">
...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td>
			<button ><a href="borrarpantalon.php?idpantalones=<?php  echo $fila['idpantalones'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar este pantalon?');" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
