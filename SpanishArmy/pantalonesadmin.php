		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="añadirpantalon.php?idpantalones=<?php  echo $fila['idpantalones'];?>" value="añadir" name="añadir"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
...
//usamos una funcion que nos permite mostrar las pantalones de la base de datos

	$result = mostrarpantalones($conexion);
...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td id="td"><b> <?php echo $fila['idpantalones'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Nombre'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Precio'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Descripcion'] ?> </b></td>
		<td id="td"><b> <img class="imagen" style="width: 200px;" src="<?php echo $fila['Imagen']; ?>"> </b></td>

		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="borrarpantalon.php?idpantalones=<?php  echo $fila['idpantalones'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta pantalon?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a class="nav-link active" aria-current="page" href="actualizarpantalon.php?idpantalones=<?php echo $fila['idpantalones']; ?>" value="Modificar" name="Modificar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
