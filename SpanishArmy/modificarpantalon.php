...
//Cogemos las variables que vamos a usar
	...
	$idpantalones = $_POST['idpantalones'];
...
//utilizamos la funcion para modificar el pantalon 

	$consulta = modificarpantalon($conexion,$nombre,$precio,$descripcion,$idpantalones,$rutaimagen);
