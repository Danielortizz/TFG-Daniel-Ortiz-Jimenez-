		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="añadiroferta.php?idoferta=<?php  echo $fila['idoferta'];?>" value="añadir" name="añadir"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td id="td"><b> <?php echo $fila['idoferta'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Nombre'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Precio'] ?> </b></td>
		<td id="td"><b> <?php echo $fila['Talla'] ?> </b></td>
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="borraroferta.php?idoferta=<?php  echo $fila['idoferta'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta oferta?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a class="nav-link active" aria-current="page" href="actualizaroferta.php?idoferta=<?php echo $fila['idoferta']; ?>" value="Modificar" name="Modificar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
