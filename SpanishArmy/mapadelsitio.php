...
<body background="img/fondo2.jpg">
 ...
 <div class="cuerpo">
	...
	<a href="mapadelsitio.php"><p align="center"><FONT FACE="Impact" size="500px" class="titulocarrusel" >MAPA DEL SITIO</FONT></p></a>
...
<div class="item1">
	...
	<p align="center"><FONT FACE="Impact" size="500px" class="mapadelsitio" >INICIO</FONT></p>

		<a href="home.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >HOME</FONT></p></a>
...
<div class="item3">
	...
	<p align="center"><FONT FACE="Impact" size="500px" class="mapadelsitio" >TIENDA</FONT></p>


		<a href="camisetas.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >CAMISETAS</FONT></p></a>

		<a href="pantalones.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >PANTALONES</FONT></p></a>

		<a href="botas.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >BOTAS</FONT></p></a>

		<a href="mochilas.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >MOCHILAS</FONT></p></a>

		<a href="ofertas.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >OFERTAS</FONT></p></a>

</div>

<div class="item4">

	<p align="center"><FONT FACE="Impact" size="500px" class="mapadelsitio" >INFORMACIÓN</FONT></p>

		<a href="noticias.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >NOTICIAS</FONT></p></a>

		<a href="dieta.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >DIETA Y ENTRENO</FONT></p></a>

		<a href="preguntas.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >PREGUNTAS FRECUENTES</FONT></p></a>

		<a href="exclusiones.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >EXCLUSIONES</FONT></p></a>

		<a href="baremo.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >BAREMO 2021</FONT></p></a>

		<a href="cefot.php"><p align="center"><FONT FACE="Impact" size="50px" class="mapadelsitio" style="color: black;" >MATERIAL CEFOT</FONT></p></a>
