...
//Guardamos en una variable la funcion que vamos a usar mas tarde, en este caso para coger el precio de una mochila
  ...
  <?php require('header.php'); ?>
    ...
    <div class="cuerpo">
          ...
          <div class="row">
					<?php
                        $precio = $_GET['Precio'];
                        $filtro = filtromochilaprecio($conexion,$precio);
						while ($fila = mysqli_fetch_assoc($filtro)) {?>
							<div class="card" id="carta-catalogog" style="width: 18rem;">
                                     ...
                                     <p align="center" ><a href="detallesmochilas.php?idmochilas=<?php echo $fila['idmochilas']; ?>" class="btn btn-dark" >COMPRAR</a></p>
