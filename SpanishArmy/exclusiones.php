...
<div align="center" class="cuadro">
	<p align="center"><FONT FACE="Impact" size="500px" class="titulocarrusel" >EXCLUSIONES</FONT></p>

	<h4><font face="Impact" class="titulocarrusel" style="color: white; ">Exclusiones por Parámetros Biológicos</font></h4>
	...
	<h4 ><font face="Impact" class="titulocarrusel" style="color: white; font-size: 20px; ">Exclusiones de la Piel</font></h4>
		...
		<h4 ><font face="Impact" class="titulocarrusel" style="color: white; font-size: 20px;">Exclusiones Neurolígicas</font></h4>

		<ul style="background: white; font-size: 20px;">
			Anomalías congénitas o adquiridas del sistema nervioso central.</li>
			Enfermedades crónicas sistematizadas.</li>
			Lesiones traumáticas craneoencefálicas, vertebromedulares o de nervios periféricos.</li>
			Epilepsia.</li>
			Movimientos anormales uni o bilaterales.</li>
			Síndromes neurológicos que afecten a las funciones corticales.</li>
			Enfermedades metabólicas que alteren el sistema nervioso</li>
		</ul>

		<h4 ><font face="Impact" class="titulocarrusel" style="color: white; font-size: 20px;">Exclusiones del Aparato Digestivo</font></h4>

	    <ul style="background: white; font-size: 20px;" >
			Afecciones congénitas o adquiridas de los órganos de la boca.</li>
			Cualquier alteración de los maxilares.</li>
			Sialorrea.</li>
			Afecciones del esófago, estómago, recto, ano, hígado, vías biliares y páncreas que dificulten las funciones.</li>
			Neoformaciones benignas.</li>
			Enfermedades del mediastino.</li>
			Anomalías y disfunción diafragmática.</li>
		</ul>

	<h4 ><font face="Impact" class="titulocarrusel" style="color: white; font-size: 20px;">Exclusiones de Órganos</font></h4>

		<ul style="background: white; font-size: 20px;">
			Alteraciones congénitas o adquiridas del corazón.</li>
			Antecedentes de síncope o lipotimias repetidas.</li>	
			Enfermedades valvulares, incluso corregidas quirúgicamente.</li>
			Cardiopatía isquémica.</li>
			Síndrome de preexcitación</li>
			Insuficiencia cardíaca.</li>
			Miocardiopatías.</li>
		</ul>

		<h4 ><font face="Impact" class="titulocarrusel" style="color: white; font-size: 20px;">Exclusiones del Aparato Locomotor</font></h4>

		<ul style="background: white; font-size: 20px;">
			Enfermedades, lesiones y anomalías de los huesos.</li>
			Ausencia o pérdida de parte de una extremidad.</li>
			Inestabilidades, esguinces o luxaciones de las principales articulaciones.</li>
			Seudoartrosis, anquilosis y rigideces.</li>
			Infecciones del tejido óseo, articular o muscular.</li>
			Cifosis superior a 45 grados.</li>
			Escoliosis superiores a 15 grados.</li>
			Atrofia o distrofia de un miembro superior o inferior.</li>
			Alteraciones anatómicas que provoquen falta de poder de aprehensión de la mano.</li></b>
		</ul>
	</div>
