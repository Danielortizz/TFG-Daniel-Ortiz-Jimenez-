		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="añadirmochila.php?idmochilas=<?php  echo $fila['idmochilas'];?>" value="añadir" name="añadir"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
...
//usamos una funcion que nos permite mostrar las mochilas de la base de datos
	$result = mostrarmochilas($conexion);
...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td id="td"><b> <?php echo $fila['idmochilas'] ?> </b></td>
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a href="borrarmochila.php?idmochilas=<?php  echo $fila['idmochilas'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta mochila?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
		...
		<td>
			<ul class="nav justify-content-center">
		  		<li class="nav-item" id="botones">
		    		<a class="nav-link active" aria-current="page" href="actualizarmochila.php?idmochilas=<?php echo $fila['idmochilas']; ?>" value="Modificar" name="Modificar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
