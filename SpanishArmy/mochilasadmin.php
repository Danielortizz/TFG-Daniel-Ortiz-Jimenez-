...
<ul class="nav justify-content-end" id="barra">
		    <li class="nav-item">
		    <a class="nav-link active" aria-current="page" href="añadirmochila.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus" viewBox="0 0 16 16">
...
//recorre la consulta y los muestra
	...
	<tr>
		...
		<td>
			<button ><a href="borrarmochila.php?idmochilas=<?php  echo $fila['idmochilas'];?>" value="eliminar" name="eliminar" onclick="return confirm('Estás seguro que quieres eliminar esta mochila?');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-reverse" viewBox="0 0 16 16">
