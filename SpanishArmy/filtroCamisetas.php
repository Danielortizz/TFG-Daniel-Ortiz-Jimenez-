...
//Guardamos en una variable la funcion que vamos a usar mas tarde, en este caso para coger el precio de una camiseta 
  ...
  <?php require('header.php'); ?>
    ...
    <div class="cuerpo">
          ...
          <div class="row">
					<?php
                        $precio = $_GET['Precio'];                        
                        $filtro = filtrocamisetaprecio($conexion,$precio);
						while ($fila = mysqli_fetch_assoc($filtro)) {?>
							<div class="card" id="carta-catalogog" style="width: 18rem;">
                                     ...
                                     <p align="center" ><a style="color: white; align-content: center;" class="btn btn-dark" href="detallescamisetas.php?idcamisetas=<?php echo $fila['idcamisetas']; ?>" value="Comprar" name="Comprar">COMPRAR</a></p>
